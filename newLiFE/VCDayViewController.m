...
@implementation VCDayViewController
...
-(void)drawResult:(int)index{
    ...
    if(dataStateType == DATA_STATE_TYPE_SLEEP){
        if(dataValueType == DATA_VALUE_TYPE_RUN){
            ...
            UILabel *timeLabel = [[UILabel alloc] initWithFrame:CGRectMake(110, 510, 190, 25)];
            ...
            UILabel *resultLabel = [[UILabel alloc] initWithFrame:CGRectMake(65, DATA_RESULT_LABEL_Y + 20, 190, 25)];
            ...
            if(per < 100){
                ...
                UILabel *label = [[UILabel alloc] initWithFrame:CGRectMake(DATA_RESULT_MESSAGE_LABEL_X, DATA_RESULT_MESSAGE_LABEL_Y, 190, 25)];
            ...
            NSAttributedString *string2 = [[NSAttributedString alloc] initWithString:@"11:28" attributes:stringAttributes2];
            NSMutableAttributedString *mutableAttributedString = [[NSMutableAttributedString alloc] init];
            [mutableAttributedString appendAttributedString:string1];
            [mutableAttributedString appendAttributedString:string2];
            ...
            NSAttributedString *string4 = [[NSAttributedString alloc] initWithString:@"06:54" attributes:stringAttributes2];
    ...
    if(dataValueType == DATA_VALUE_TYPE_RUN){
        ...
        switch(dataState) {
            ...
            case DATA_STATE_TYPE_RUN:{
                self.leftCommonButton.hidden = NO;
                [self.leftCommonButton setBackgroundImage:[UIImage imageNamed:@"LiFE_Left_GoalButton"] forState:UIControlStateNormal];
