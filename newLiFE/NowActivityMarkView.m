...
@implementation NowActivityMarkView
...
- (void)drawRect:(CGRect)rect
{
    ...
    if(steps != nil){
        ...
        /***** sleepの描画 *****/
        if([[sleepArray objectAtIndex:index] intValue] > -1){
            int sleepValue = [[sleepArray objectAtIndex:index] intValue];
            float scale;
        ...
        /***** runの描画 *****/
        if([[runArray objectAtIndex:index] intValue] > 0){
            int beforei = index - 1;
