...
@interface DayViewController : UIViewController <UIGestureRecognizerDelegate,CLLocationManagerDelegate,ECSlidingViewControllerDelegate,UIActionSheetDelegate>
{
    NSDate *prevDate;
